...
function IntelligentAquaVerticalFarming() {
    const heading = "Intelligent Aqua Vertical Farming";
    const image = "https://bariflolabs.com/wp-content/uploads/2019/10/blog-ww-1.jpg";
...
export default IntelligentAquaVerticalFarming
