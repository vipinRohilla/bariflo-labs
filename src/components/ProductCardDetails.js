export const ProductCardDetails = [
    ...
    {
        heading: "04",
        para : "VIBRO is a robot which takes out sediment waste and treats water regularly. Also it infuses banovalent bacteria and microalgae for waste reduction.These devices are part of AI-IoT based farm management system for aquafarms. It is one of its kind in aquafarming looking into GenEx farmers’ needs.",
